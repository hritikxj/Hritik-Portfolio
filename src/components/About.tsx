export default function About() {
  ...
  return (
    <section id="about" className="scroll-mt-16 px-[clamp(20px,4vw,40px)] py-[clamp(40px,8vw,80px)] border-y-[0.5px] border-border-subtle">
      <div className="flex justify-between items-baseline mb-12 pb-5 border-b-[0.5px] border-border-subtle">
        <h2 className="font-display text-[clamp(32px,4vw,42px)] font-light text-ink">About</h2>
        <span className="text-[11px] text-smoke tracking-[0.1em]">02 / About</span>
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-[clamp(40px,6vw,80px)] items-start">
        <div className="aspect-3/4 bg-parchment rounded relative flex items-end p-5">
        ...
        <div>
          <p className="font-display text-[clamp(24px,3vw,32px)] font-light leading-[1.3] mb-7">
