...
export default function Hero() {
  ...
  return (
    <section className="min-h-[clamp(400px,80vh,800px)] pt-8 md:pt-16 pb-[40px] px-[clamp(20px,4vw,40px)] grid grid-cols-1 lg:grid-cols-2 gap-[60px] items-center border-b-[0.5px] border-border-subtle">
      <div className="flex flex-col items-start">
        ...
        <h1 className="font-display text-[clamp(42px,6vw,68px)] font-light leading-[1.05] tracking-[-0.01em] mb-8">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button onClick={() => scrollTo('contact')} className="bg-transparent text-ink px-8 py-3.5 font-body text-xs tracking-[0.08em] uppercase border-[0.5px] border-border-subtle cursor-pointer rounded-sm transition-colors duration-200 hover:border-ink">
            Hire Me →
          </button>
        </div>
        <div className="flex flex-wrap justify-between gap-[clamp(20px,3vw,40px)] mt-8 pt-8 border-t-[0.5px] border-border-subtle w-full">
          <div>
            <span className="font-display text-[clamp(28px,4vw,36px)] font-light text-ink block">17K</span>
            <span className="text-[11px] text-smoke tracking-[0.06em]">Instagram Following</span>
          </div>
          <div>
            <span className="font-display text-[clamp(28px,4vw,36px)] font-light text-ink block">4+</span>
            <span className="text-[11px] text-smoke tracking-[0.06em]">Years Designing</span>
          </div>
          <div>
            <span className="font-display text-[clamp(28px,4vw,36px)] font-light text-ink block">∞</span>
            <span className="text-[11px] text-smoke tracking-[0.06em]">Disciplines</span>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-2 grid-rows-[1.75fr_1fr] gap-[clamp(8px,1.5vw,12px)] h-[clamp(350px,50vh,500px)]">
        <div 
        ...
        >
          <div>
            <div className="font-display text-[clamp(20px,3vw,28px)] font-light text-off-white leading-[1.1]">Brand<br />Identity</div>
          </div>
        </div>
